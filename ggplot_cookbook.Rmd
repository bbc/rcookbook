---
title: "BBC Visual Journalism data team's cookbook for R graphics"
...
<<<<<<< HEAD
* `save_filepath`: the relative or precise filepath that you want your graphic to save to, including the `.png` extension at the end. This does depend on your working directory and if you are in a specific R project. An example filepath would be: `Users/stylin02/bbc/r/vjdata.18529.nhs.ambulance.delays/output/charts/chart.png`.
* `width_pixels`: this is set to 640px by default, so only call this argument if you need your chart to be a different width, and specify what you want it to be. 
* `height_pixels`: this is set to 450px by default, so only call this argument if you need your chart to be a different height and specify what you want it to be. 
* `logo_image_path`: the filepath to the logo image you would like to appear at the bottom right side of your plot, in the footer, which needs to be a PNG file. By default this is set to an empty background image, but you are able to change this and add your own image or logo if you wish. 
=======
...
>>>>>>> ca03605b929695901f5b1d7c6282e240cf583e20
...
filename_that_my_plot_should_be_saved_to-nc.png
